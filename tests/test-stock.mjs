...
['expiring', 'nonmoving', 'negmargin'].forEach(f => ok(!!doc.querySelector(`[data-invf="${f}"]`), `filter: ${f}`));
...
ok(!!doc.querySelector('[data-invf="nonmoving"]'), 'Non-moving still works — it needs sales, not expiry');
